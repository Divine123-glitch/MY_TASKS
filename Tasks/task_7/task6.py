...
# Guardian info
guard_name = input("Enter your guardian's name: ").title().split(" ")
guard_nums = input("Enter your guardian's phone number: ").split(" ")

# Subject info
subject = ("English", "Maths", "TD")
score1 = float(input(f"Enter the score for {subject[0]}: "))
...
profile = {
    ...
    "Guardian":{
        "G_name": guard_name, "G_number": guard_nums
    },
...
# Initials
profile["Student info"]["Initials"] = [i[0] for i in name.split(" ")]
...
# Output
print("STUDENT PROFILE".center(100,".")) 
print(f"Name: \t\t{profile["Student info"]["Name"]}") 
